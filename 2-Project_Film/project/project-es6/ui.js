class UI{
  ...
  static clearInputs(el1,el2,el3,el4,el5,el6,el7,el8){
    el1.value = '';
    el2.value = '';
    el3.value = '';
    el4.value = '';
  ...
  static deleteFilmFromModal(element){
